...
export default function App() {
  ...
  // useFonts returns an array where the first element is a boolean that indicates whether or not the fonts have been loaded. Using object destructring here to grab that boolean value
